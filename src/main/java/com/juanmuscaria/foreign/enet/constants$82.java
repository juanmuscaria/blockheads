...
final class constants$82 {
    ...
    static final VarHandle const$1 = constants$82.const$0.varHandle(MemoryLayout.PathElement.groupElement("outgoingPeerID"));
    static final VarHandle const$2 = constants$82.const$0.varHandle(MemoryLayout.PathElement.groupElement("incomingSessionID"));
    static final VarHandle const$3 = constants$82.const$0.varHandle(MemoryLayout.PathElement.groupElement("outgoingSessionID"));
    static final VarHandle const$4 = constants$82.const$0.varHandle(MemoryLayout.PathElement.groupElement("mtu"));
    static final VarHandle const$5 = constants$82.const$0.varHandle(MemoryLayout.PathElement.groupElement("windowSize"));
}
