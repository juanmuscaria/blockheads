...
final class constants$100 {
    ...
    static final VarHandle const$0 = constants$99.const$2.varHandle(MemoryLayout.PathElement.groupElement("incomingReliableSequenceNumber"));
    static final VarHandle const$1 = constants$99.const$2.varHandle(MemoryLayout.PathElement.groupElement("incomingUnreliableSequenceNumber"));
    ...
    static final VarHandle const$3 = constants$100.const$2.varHandle(MemoryLayout.PathElement.groupElement("host"));
    static final VarHandle const$4 = constants$100.const$2.varHandle(MemoryLayout.PathElement.groupElement("outgoingPeerID"));
    static final VarHandle const$5 = constants$100.const$2.varHandle(MemoryLayout.PathElement.groupElement("incomingPeerID"));
}
