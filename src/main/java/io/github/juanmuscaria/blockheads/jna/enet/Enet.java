package io.github.juanmuscaria.blockheads.jna.enet;
...
public interface Enet extends Library {
    String JNA_LIBRARY_NAME = (Platform.isWindows()? "libenet.dll":"libenet.so");
     ...
     * @{<br>
     * Original signature : <code>ENetSocket enet_socket_create(ENetSocketType)</code><br>
     * <i>native declaration : enet/enet.h:486</i>
     */
    Enet.ENetSocket enet_socket_create(int ENetSocketType1);
    /**
     ...
     * @deprecated use the safer methods {@link #enet_socket_accept(Enet.ENetSocket, ENetAddress)} and {@link #enet_socket_accept(com.sun.jna.Pointer, ENetAddress)} instead
     */
    @Deprecated
    Enet.ENetSocket enet_socket_accept(Pointer ENetSocket1, ENetAddress ENetAddressPtr1);
    /**
     * Original signature : <code>ENetSocket enet_socket_accept(ENetSocket, ENetAddress*)</code><br>
     * <i>native declaration : enet/enet.h:490</i>
     */
    Enet.ENetSocket enet_socket_accept(Enet.ENetSocket ENetSocket1, ENetAddress ENetAddressPtr1);
    /**
     ...
     * @deprecated use the safer methods {@link #enet_socket_wait(java.nio.IntBuffer, int)} and {@link #enet_socket_wait(com.sun.jna.ptr.IntByReference, int)} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer methods {@link #enet_socket_get_option(int, java.nio.IntBuffer)} and {@link #enet_socket_get_option(int, com.sun.jna.ptr.IntByReference)} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer methods {@link #enet_address_set_host_ip(ENetAddress, java.lang.String)} and {@link #enet_address_set_host_ip(ENetAddress, com.sun.jna.Pointer)} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer methods {@link #enet_address_set_host(ENetAddress, java.lang.String)} and {@link #enet_address_set_host(ENetAddress, com.sun.jna.Pointer)} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer methods {@link #enet_address_get_host_ip(ENetAddress, java.nio.ByteBuffer, Size_t)} and {@link #enet_address_get_host_ip(ENetAddress, com.sun.jna.Pointer, Size_t)} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer methods {@link #enet_address_get_host(ENetAddress, java.nio.ByteBuffer, Size_t)} and {@link #enet_address_get_host(ENetAddress, com.sun.jna.Pointer, Size_t)} instead
     */
    @Deprecated
    ...
    /**
     * @}<br>
     * Original signature : <code>ENetPacket* enet_packet_create(const void*, size_t, enet_uint32)</code><br>
     ...
     * @deprecated use the safer methods {@link #enet_peer_receive(ENetPeer, java.nio.ByteBuffer)} and {@link #enet_peer_receive(ENetPeer, com.sun.jna.Pointer)} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer methods {@link #enet_range_coder_compress(com.sun.jna.Pointer, ENetBuffer, Size_t, Size_t, java.nio.ByteBuffer, Size_t)} and {@link #enet_range_coder_compress(com.sun.jna.Pointer, ENetBuffer, Size_t, Size_t, com.sun.jna.Pointer, Size_t)} instead
     */
    @Deprecated
     ...
     * @deprecated use the safer methods {@link #enet_range_coder_decompress(com.sun.jna.Pointer, java.nio.ByteBuffer, Size_t, java.nio.ByteBuffer, Size_t)} and {@link #enet_range_coder_decompress(com.sun.jna.Pointer, com.sun.jna.Pointer, Size_t, com.sun.jna.Pointer, Size_t)} instead
     */
    @Deprecated
